...
# model.load_weights("/Users/william/Documents/gitHub/B20IT38/plaidml_test_model/models/base_model/weight_saves/weight_save.hdf5", by_name=True)

model.compile(optimizer='adam',  # Good default optimizer to start with
              loss='sparse_categorical_crossentropy',  # how will we calculate our "error." Neural network aims to minimize loss.
              metrics=['accuracy'])  # what to track

checkpointer = ModelCheckpoint(filepath='models/base_model/weight_saves/weight_save2.hdf5', verbose=1, save_best_only=True)  # saves the models weights after each epoch if the validation loss decreased
